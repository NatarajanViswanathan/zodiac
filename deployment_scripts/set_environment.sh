...
export SIRMIONE_ALIAS=nv2020
export LIMONE_ALIAS=nv2020
export SCORPIO_ALIAS=nv2020
export VIRGO_ALIAS=nv2020
export LIBRA_ALIAS=nv2020
export ZODIAC_ALIAS=nv2020
export DB_ADMIN_USER=natraj
